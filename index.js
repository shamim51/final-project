 ...
 // const li = document.createElement('li');
    ...
    function generateList() {
        ...
        obj.forEach((crime) => {
            ...
            a.innerText = crime.crimeTitle;
            a.href = '#';
            p.innerHTML = "<strong>Crime Description</strong>"+"<br>"+crime.crimeDescription;
            const colblue = "\"color:#0000FF\"";
            p2.innerHTML = "<strong>Posted by </strong><i style="+colblue+">"+crime.username+"</i>";
